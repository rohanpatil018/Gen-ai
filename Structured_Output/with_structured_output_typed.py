...
class Review(TypedDict):
    ...
    keythems:Annotated[list[str],"Write down all the key themes discussed in a review in a list"]
    summary:Annotated[str,'A brief summary of review']
    sentiment:Annotated[Literal['Positive','Negative','Neutral'],'return sentiment of the review either positive, negative or other']
    pros:Annotated[Optional[list[str]],'Write dwon all the pros inside a list']
    cons:Annotated[Optional[list[str]],'Write dwon all the cons inside a list']
