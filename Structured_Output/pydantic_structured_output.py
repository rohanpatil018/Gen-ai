...
class Review(BaseModel):
    ...
    sentiment:Literal['Positive','Negative','neutral']=Field(description='return sentiment of the review either positive, negative or other')
    pors:Optional[list[str]]=Field(description='Write dwon all the pros inside a list')
    cons:Optional[list[str]]=Field(description='Write dwon all the cons inside a list')
    name:Annotated[Optional[str],Field(description='Write the name of the reviewer')]
